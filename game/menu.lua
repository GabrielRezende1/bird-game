...
function menu:draw()
    ...
    love.graphics.rectangle("line", self.startButtonX, self.buttonY, self.buttonWidth, self.buttonHeight)
    love.graphics.print("Start", self.startButtonX + 48, self.buttonY + 12)

    love.graphics.rectangle("line", self.quitButtonX, self.buttonY + 70, self.buttonWidth, self.buttonHeight)
